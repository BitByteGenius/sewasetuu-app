...
import 'package:sewasetu/modules/stay/bindings/stay_binding.dart';
...
import 'package:sewasetu/modules/stay/widgets/stay_category_bar_widget.dart';
...
class Staylist extends GetView<StayController> {
  const Staylist({super.key});

  @override
  StayController get controller {
    if (!Get.isRegistered<StayController>()) {
      StayBinding().dependencies();
    }
...
typedef StayListPage = Staylist;
typedef StayListScreen = Staylist;
